...
it('works', () => {
  ...
  expect(formatPercent(0, 2)).toEqual('0.00%')
  expect(formatPercent(-0.023, 2)).toEqual('-2.30%')
  expect(formatPercent(0.023, 2, true)).toEqual('+2.30%')
  expect(formatPercent(-0.023, 2, true)).toEqual('-2.30%')
  expect(formatPercent(0, 2, true)).toEqual('0.00%')
})
