...
it('works', () => {
  expect(formatNum(131.137313)).toEqual('131.137313')
  expect(formatNum(131.137313, 0)).toEqual('131')
  expect(formatNum(131.737313, 0)).toEqual('132')
  expect(formatNum(1312131, 0)).toEqual('1,312,131')
  ...
  expect(formatNum(1311248231.73531)).toEqual('1,311,248,231.73531')
